...
# Method 1 (This method doesn't fulfill the task assumption: train the model from the begining with few shots, no transferable parameters. But it can be introduced as a benchmark)
