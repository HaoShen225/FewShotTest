...
This step aims to represent structure information with the sparec code combination from the first step. Assume that a sensing field is $\left{(x,y)|x\in \Omega_{x},y\in \Omega_{y}\right}$
